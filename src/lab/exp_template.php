...
<!-- The lab Header contains the logo and the name of the lab,
	...
	<div class="breadcrumb" id="experiment-article-breadcrumb"><a href="<?php echo $vlab_url?>">Home</a><a></a> &gt; <a href="<?php echo $lab_url?>">Bio-Medical Instrumentation Lab</a>    </div>
